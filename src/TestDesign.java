...
/*
 * This is a class designed to test the functionality of the Hamper Ordering System.
 */
...
public class TestDesign {
	...
	/* 
	 * This test checks to see if the addFamily() method in Order successfully adds a Family to the
	 * Family ArrayList.
	 */
	@Test
	 ...
	 * successfully creates a Hamper object for the Family object it is called from.
	 */
    @Test
    ...
    public void testOrderSummaryFormatSummary() {
    	fillSQLData();
    	String expectedOutput = "Hamper Order Form\n\nName:\nDate:\n\nNumber of males, females, children over eight and children under eight for Hamper 1 are 0, 0, 1, 0 respectively.\n"
    							+ "Hamper 1 Items:\n1  Tomato Sauce\n2  Pasta\n3  Beef\n4  Apples";
    	Order testOrder = new Order();
    	testOrder.addFamily(0,0,1,0);
	 ...
	 * test file to check the functionality of the getters of Hamper class.
	 */
    @Test
	 ...
	 * but there are insufficient food items inside the inventory, then method fillHamper will pass in
    ...
    */
	...
	/* 
	 * If the valid is false, no update in inventory should take place, so this test is just making sure if 
	 * inventory as same number of foodItems as it had before creating Hamper and after creating hamper.
	 */
    @Test
	...
	/* 
	 * This is the test for food items in which we check the amount of grain, fv, protein, other, 
	 * calories content and item id and compare the expected values of these to the actual values.
	 */
	@Test 
	...
	/*
	 * Test for setters in SQLData checks if the reference of the object passed in setter is same 
	 * as the reference of the object returned by their respective getters.
	 */
	@Test
	 ...
	 * this method will only be called when order is unsuccessful in the actual program.
	 */	
	@Test
