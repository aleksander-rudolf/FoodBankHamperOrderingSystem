...
public class SQLData {
	...
	/* 
	 * This method is for making a connection to the database.
	 * ArrayList<ClientType> is filled up by ClientType objects loaded from database, and
	 * Inventory is filled up by FoodItem objects loaded from the database.
	 */
	...
	/* 
	 * This method is for the updating the Database after completion of a successful order.
