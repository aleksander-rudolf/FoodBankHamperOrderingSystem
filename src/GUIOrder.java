...
public class GUIOrder extends JFrame implements ActionListener, MouseListener{
    ...
    /**
     * Write's the OrderSummary to a .txt file.
     * @param sentence
     * @param numOfORders
     */
    ...
    /*
     * Event Handler based on which button is pressed on the GUI.
     */
    ...
    /*
     * Event Handler of different MouseActions.
     */
    ...
    /*
     * Validates all of the user-input to the GUI by checking for IllegalArguments and Boundary Conditions.
     */
