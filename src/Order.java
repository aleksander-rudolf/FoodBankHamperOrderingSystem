...
public class Order implements OrderSummary {
	...
	/**
	 * This getters returns Family at particular index taking index as argument.
	 * @param index
	 * @return Family
	 */
	...
	/**
	 * Returns a string of nutrition components which are insufficient inside inventory.
	 * @return
	 */
	 ...
	 * returns string summarizing order details.
	 * @return String
	 */
	@Override
	public String formatSummary() {
		...
		for(int i = 0; i < this.families.size(); i++) {
			formattedSummary.append("Number of males, females, children over eight and children under eight for Hamper " + (i+1) +" are "+families.get(i).getNumOfMales()+", "+
		    families.get(i).getNumOfFemales()+", "+families.get(i).getNumOfChildrenOver8()+", "+families.get(i).getNumOfChildrenUnder8()+" respectively.\n");
